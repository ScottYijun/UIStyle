...
void MainWindow::initUI()
{
    ...
    m_topWidget = new MainTopWidget(this);//顶部900X440

    m_bottomWidget = new MainBottomWidget(this);//底部900X60
