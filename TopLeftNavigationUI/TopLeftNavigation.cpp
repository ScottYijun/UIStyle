...
#include "TopLeftNavigation.h"
#include "ui_TopLeftNavigation.h"
#include "iconhelper.h"

TopLeftNavigation::TopLeftNavigation(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::TopLeftNavigation)
{
    ui->setupUi(this);
    this->initForm();
    this->initLeftMain();
...
TopLeftNavigation::~TopLeftNavigation()
{
    delete ui;
}

void TopLeftNavigation::initForm()
{   
...
void TopLeftNavigation::buttonClick()
{
...
void TopLeftNavigation::initLeftMain()
{
...
void TopLeftNavigation::initLeftConfig()
{
...
void TopLeftNavigation::leftMainClick()
{
    QToolButton *b = (QToolButton *)sender();
    QString name = b->text();
...
void TopLeftNavigation::leftConfigClick()
{
    QToolButton *b = (QToolButton *)sender();
    QString name = b->text();
...
void TopLeftNavigation::on_btnMenu_Min_clicked()
{
    showMinimized();
}

void TopLeftNavigation::on_btnMenu_Max_clicked()
{
...
void TopLeftNavigation::on_btnMenu_Close_clicked()
{
    close();
}
